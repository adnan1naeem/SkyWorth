  ...
  return (
    <Box sx={containerStyles}>
      ...
      <Typography variant="body1" sx={subheadingStyles}>
        SKYWORTH Development Malaysia Sdn. Bhd. was established on Nov 28, 2016; it is 100% held by SKYWORTH Group.
      </Typography>
