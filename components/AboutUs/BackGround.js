...
function BackGround() {
  ...
  const fullText = (
    <>
      ...
      Apart from mainland China and Hong Kong, SKYWORTH Group operates in other areas in Asia, such as the Philippines, Malaysia, Indonesia, Thailand, Vietnam and India, as well as South Africa, Germany and the USA.
  ...
  const previewText = fullText.props.children.slice(0, 500); // Show the first 300 characters
  ...
  return (
    <Box sx={containerStyles}>
      ...
      <Typography variant="body1" sx={bodyTextStyles}>
        ...
        <span style={{ color: "#0069c8", cursor: "pointer" }} onClick={() => setIsExpanded(!isExpanded)}>
