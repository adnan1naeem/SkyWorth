    ...
    Refrigerator: [
      {
        ...
        popularity: 3,
        views: 80,
        des: "Check if the temperature setting is correct and if the door seals are intact.",
      },
    ...
    ChestFreezer: [
      {
        ...
        popularity: 2,
        views: 70,
        des: "Unplug the freezer, remove food, and let it defrost naturally.",
      },
    ...
    AC: [
      {
        ...
        popularity: 6,
        views: 110,
        des: "Check the thermostat setting and ensure the filters are clean.",
      },
      // Add more AC questions...
    ],
  };
