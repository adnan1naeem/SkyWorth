  ...
  return (
    <Box sx={{ paddingTop:paddingTop?paddingTop:{xs: '25%',sm: '18%',md: '12%',lg: '12%'}, marginBottom: '20px',width:'40%' }}>
      <Breadcrumbs aria-label="breadcrumb">
        <Link href="/" passHref>
          <Typography sx={{fontSize:"21px",fontFamily:'SKSans,sans-serif',fontWeight:300}} color='#015ccb'>Home</Typography>
        </Link>
        {pathParts.map((part, index) => {
          ...
          return (
            <Link key={index} href={href} style={{color:'black'}} passHref>
              <Typography sx={{fontSize:"21px",fontFamily:'SKSans,sans-serif',color:'#000000',fontWeight:300}}>
